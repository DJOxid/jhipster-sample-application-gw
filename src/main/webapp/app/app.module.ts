...
import { JhipsterSampleApplicationGwSharedModule } from 'app/shared';
import { JhipsterSampleApplicationGwCoreModule } from 'app/core';
...
@NgModule({
  imports: [
    ...
    JhipsterSampleApplicationGwSharedModule.forRoot(),
    JhipsterSampleApplicationGwCoreModule,
